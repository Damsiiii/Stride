            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
              {pillars.map((item, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="flex flex-col gap-1.5 border-l border-white/10 pl-3.5 py-1"
                  >
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {stats.map((stat, idx) => (
                <div
                  key={idx}
                  className="group relative flex flex-col justify-between border border-white/[0.08] bg-white/[0.02] p-8 sm:p-10 transition-all duration-300 hover:border-[#D6FF57]/40 hover:bg-white/[0.04]"
                >
                  ...
                  <p className="text-[12px] text-white/40 font-light border-t border-white/[0.06] pt-3">
                    {stat.desc}
                  </p>
                </div>
              ))}
